...
class ProcessController < ApplicationController
  ...
  def update_settings
    file_content =  "contrast: #{params[:contrast]}"\
                    "\nxcoord: #{params[:xcoord]}"\
                    "\nycoord: #{params[:ycoord]}"
    File.open("#{Rails.root}/config/settings.yml", 'w') do
  ...
  def generate_unique_code
    random_generated_code = SecureRandom.urlsafe_base64(nil, false)
    p = Person.where(id: @photo.person_id).first
    p.unique_code = random_generated_code
    p.save
    UniqueCodeMailer.code_email(p).deliver if Rails.env == 'production'
  end
  ...
  def person_key_check # Secure key for Person actions
    t = '1b36fc3a3461ecf662b8b839ab7c96ad643e77c886f31346a259bb4bc69b6ab87266'\
  ...
  def image_key_check # Secure key for image actions
    t = '48d2fc2358a74103eddcfc91ce56b845704aa557d6cfd12d83a064ba315118e982f4c'\
    '049b1ad309176d5593475b06ac6c1736bfa609349c981cb29687ad44e0'
    die unless params[:post_token] == t
  end
